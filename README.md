...
- Dapat kita lihat setelah melakukan refactor, perbedaan waktu menurun bahkan lebih dari 20%. Contohnya, dari `/all-student` waktu awal 188880 menjadi 5443. Hal ini juga berlaku di `/highest-gpa` dan `/all-student-name` perbedaan waktu sangat signifikan. Hal ini menunjukkan bahwa optimasi dengan refactoring fungsi berpengaruh juga terhadap pengujian aplikasi menggunakan JMeter.
